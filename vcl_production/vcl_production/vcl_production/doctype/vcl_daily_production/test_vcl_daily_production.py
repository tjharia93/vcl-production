...
bench, in tests/test_reporting.py. What is tested here is only the part that
...
from vcl_production.api import add_item, close_day, update_item
from vcl_production.setup.seed import seed_machines
from vcl_production.vcl_production.doctype.vcl_production_job.vcl_production_job import find_job
